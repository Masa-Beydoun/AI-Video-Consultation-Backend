...
SECRET_KEY = 'django-insecure-a_gw8wnh%vev%_&a%i%1i2*d5%a#-y9_p&i8j(q(1aypjhf!_l'
...
SIMPLE_JWT = {
    ...
    "ACCESS_TOKEN_LIFETIME": timedelta(hours=12),  # or days=7 if you want it really long
